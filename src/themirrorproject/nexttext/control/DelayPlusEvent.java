...
* then fire event when complete.
* 
* @see Timer
*/
public class DelayPlusEvent extends AbstractAction {
   ...
   */
  public DelayPlusEvent( Action action, float duration ) {
      this.action = action;
  ...
  public ActionResult behave(TextObject to) {
      ...
      if ( (now-startTime.longValue()) >= duration ) {
          ...
          // Fire event to notify delay has completed.
          res.event = true;
          return res;
      }        
